...
write.csv(sum1,"Output/windowLen125-Welch1.csv",row.names = FALSE)
write.csv(sum2,"Output/windowLen250-Welch2.csv",row.names = FALSE)
write.csv(sum3,"Output/windowLen500-Welch4.csv",row.names = FALSE)
